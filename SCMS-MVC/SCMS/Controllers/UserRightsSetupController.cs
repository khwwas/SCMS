...
namespace SCMS.Controllers
{
    public class UserRightsSetupController : Controller
    {
        ...
        public ActionResult Index(string SelectedGroup)
        {
            ...
            List<sp_GetUserMenuRightsResult> MenuRights = new DALUserMenuRights().GetUserMenuRights(SelectedGroup).Where(c => c.Mod_Id == SystemParameters.ModuleId).ToList();
        ...
        {
            List<sp_GetUserMenuRightsResult> MenuRights = new DALUserMenuRights().GetUserMenuRights(GroupId).Where(c => c.Mod_Id == SystemParameters.ModuleId).ToList();
            ViewData["UserMenuRights"] = MenuRights;
