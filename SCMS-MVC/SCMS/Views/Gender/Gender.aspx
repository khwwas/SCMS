...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function SaveRecord() {
            ...
            if (txt_Title.value == "") {
                ...
                var Url = document.getElementById('frm_GenderSetup').action;
                Url += "Gender/SaveRecord?Code=" + lcnt_txtSelectedCode.value + "&Title=" + txt_Title.value + "&Abbreviation=" + txt_Abbreviation.value;
        ...
        function DeleteRecord(Id) {
            if (confirm("Do you really want to delete this record")) {
                ...
                Url += "Gender/DeleteRecord?GId=" + Id;
                $.ajax({
                    type: "GET",
                    url: Url,
                    success: function (response) {
    ...
    <form id="frm_GenderSetup" action='<%=Url.Content("~/") %>'>
