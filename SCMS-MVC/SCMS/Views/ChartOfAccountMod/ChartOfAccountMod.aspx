...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function ResetForm() {
            ...
            document.getElementById('txt_OldCode').value = "";
            document.getElementById('txt_NewCode').value = "";
        }
       ...
       <div class="box round first fullpage grid">
        ...
        <div class="block">
            ...
            <div class="CustomCell" style="width: 100px; height: 30px;">
                <input type="text" class="CustomText" style="width: 70px;" id="txt_OldCode" name="txt_OldCode"
                    maxlength="2" />
                <script type="text/javascript">
                    $("#txt_OldCode").inputmask({ "mask": "99" });
                </script>
            </div>
            <div class="CustomCell" style="width: 97px; height: 30px;">
                New Code</div>
            <div class="CustomCell" style="width: 100px; height: 30px;">
                <input type="text" class="CustomText" style="width: 70px;" id="txt_NewCode" name="txt_NewCode"
                    maxlength="50" />
                <script type="text/javascript">
                    $("#txt_NewCode").inputmask({ "mask": "99" });
                </script>
            </div>
            <div class="Clear">
            </div>
