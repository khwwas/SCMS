    ...
    <script type="text/javascript">
        ...
        function SaveRecord() {
            ...
            if (txt_Title.value == "") {
                ...
                var Url = document.getElementById('frm_EmployeeTypeSetup').action;
                Url += "EmployeeType/SaveRecord?Code=" + lcnt_txtSelectedCode.value + "&Title=" + txt_Title.value + "&Abbreviation=" + txt_Abbreviation.value;
        ...
        function DeleteRecord(Id) {
            if (confirm("Do you really want to delete this record")) {
                ...
                Url += "EmployeeType/DeleteRecord?EmpTypId=" + Id;
                $.ajax({
                    type: "GET",
                    url: Url,
                    success: function (response) {
