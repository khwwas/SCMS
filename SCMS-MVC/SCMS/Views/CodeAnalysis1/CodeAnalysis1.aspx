    ...
    <script type="text/javascript">
        ...
        function SaveRecord() {
            ...
            if (ddl_location.value == 0) {
                ...
                Url += "CodeAnalysis1/SaveRecord?ps_Code=" + lcnt_txtSelectedCode.value + "&Location=" + ddl_location.value + "&Title=" + txt_Title.value;
        ...
        function DeleteRecord(Id) {
            ...
            if (confirm("Do you really want to delete this record")) {
                ...
                Url += "CodeAnalysis1/DeleteRecord?_pId=" + Id;
                $.ajax({
                    type: "GET",
                    url: Url,
                    success: function (response) {
