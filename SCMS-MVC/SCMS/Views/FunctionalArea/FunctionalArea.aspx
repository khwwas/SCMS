...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function SaveFunctionalArea() {
            ...
            {
                var Url = document.getElementById('frm_FunctionalArea').action;
                Url += "FunctionalArea/SaveFunctionalArea?Code=" + txt_SelectedCode.value + "&Title=" + txt_Title.value + "&Location=" + ddl_location.value;
        ...
        function DeleteRecord(Id) {
            if (confirm("Do you really want to delete this record")) {
                var MessageBox = document.getElementById('MessageBox');
                var Url = document.getElementById('frm_FunctionalArea').action;
                Url += "FunctionalArea/DeleteFunctionalArea?FunctionalAreaId=" + Id;
                $.ajax({
                    type: "GET",
                    url: Url,
                    success: function (response) {
    ...
    <form id="frm_FunctionalArea" action='<%=Url.Content("~/") %>'>
        ...
        <div class="block">
            ...
            <div style="float: right; margin-bottom: 10px;">
                <div style="float: left; margin-right: 5px;">
                    <input id="btn_Save" type="button" value="Save" class="btn btn-blue" onclick="SaveFunctionalArea();"
