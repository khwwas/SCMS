...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/javascript">
        ...
        function SaveRecord() {
            ...
            var ddl_CustomerType = document.getElementById('ddl_CustomerType');
            ...
            if (ddl_Company.value == 0) {
                ...
                ddl_location.focus();
                return;
            } else if (ddl_CustomerType.value == 0) {
                FadeIn(lcnt_MessageBox);
                ...
                Url += "Customer/SaveCustomerRecord?Code=" + lcnt_txtSelectedCode.value + "&Company=" + ddl_Company.value + "&location=" + ddl_location.value + "&CustomerType=" + ddl_CustomerType.value + "&City=" + ddl_City.value + "&Title=" + txt_Title.value + "&Address1=" + txt_Address1.value + "&Address2=" + txt_Address2.value + "&Email=" + txt_Email.value + "&Phone=" + txt_Phone.value + "&Fax=" + txt_Fax.value;
        ...
        function ResetForm() {
            ...
            document.getElementById('ddl_CustomerType').value = "";
        ...
        function EditRecord(Id) {
            ...
            document.getElementById('ddl_CustomerType').value = document.getElementById('ddl_CustomerType' + Id).innerHTML.trim().toString().replace("&nbsp", "");
        ...
        function DeleteRecord(Id) {
            if (confirm("Do you really want to delete this record")) {
                ...
                Url += "Customer/DeleteRecord?CusID=" + Id;
                $.ajax({
                    type: "GET",
                    url: Url,
                    success: function (response) {
    ...
    <form id="frm_CustomerSetup" action='<%=Url.Content("~/") %>'>
    ...
    <div class="box round first fullpage grid">
        ...
        <div class="block">
           ...
           <!-- <div class="CustomCell" style="width: 100px; height: 30px">
            ...
            <%= Html.DropDownList("ddl_CustomerType", null, new { style = "width:314px;margin-left: 9px;" })%>
            <div class="Clear">
            </div>
